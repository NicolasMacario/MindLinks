...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
        ...
        if ($usuario) {
            ...
            $link = SITE_URL . "/redefinir-senha.php?token=" . $token;
...
<div class="container-split">
    ...
    <div class="lado-esquerda">
        ...
        <form method="POST">
            ...
            <button type="submit" class="btn-primario">Enviar link de redefinição</button>
        </form>
        <?php endif; ?>

        <h3><a href="login.php">← Voltar para o login</a></h3>
    </div>

    <div class="lado-direita">
        <h1>MIND LINKS</h1>
        <p>Sem problemas — vamos te ajudar a recuperar o acesso à sua conta.</p>
    </div>
